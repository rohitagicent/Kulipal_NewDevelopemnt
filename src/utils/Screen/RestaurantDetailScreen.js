...
import {fp, wp,hp} from '../dimension';
const services = [
...
const recommended = [
  ...
  },
  {
    ...
    rating: '4.9',
    reviews: '89',
    image: 'https://images.unsplash.com/photo-1628840042765-3f69d3d021b4',
  },
  {
    id: 3,
    name: 'Chicken Tacos',
    ...
    rating: '4.9',
    reviews: '89',
    image: 'https://images.unsplash.com/photo-1594007654729-407eedc4be79',
  },
  {
    id: 4,
    ...
    rating: '4.9',
    reviews: '89',
    image: 'https://images.unsplash.com/photo-1576866209830-57d9d1953a08',
  },
  {
    id: 5,
    ...
    <ScrollView style={{flex: 1, backgroundColor: '#f9f9f9'}}>
        ...
        <View
          ...
          <TouchableOpacity
            style={{
              ...
              padding: wp(1), // Adjust padding as needed
              borderRadius: wp(2), // Makes it circular if width == height
              alignItems: 'center',
     ...
     <View style={{padding:wp(3)}}>
          ...
          <View
            ...
            <Text style={{fontSize: fp(2.2), fontWeight: 'bold',color:colors.WHITE}}>
              Bulgogi Bliss
            </Text>
            <View style={{flexDirection: 'row', alignItems: 'center',}}>
              <Text style={{color: '#333', fontSize: fp(2.5),color:colors.WHITE}}>4.3</Text>
              <Ionicons
                name="star"
                size={fp(2.2)}
                color="gold"
          ...
          <Text style={{color: 'gray', marginTop: 4,color:colors.WHITE,fontSize:fp(1.8)}}>Open 24 Hours</Text>
          ...
          <View style={{padding: wp(2),backgroundColor:colors.WHITE,
 borderTopLeftRadius: 24,
 borderTopRightRadius: 24,
        }}>
          <Text style={{color: 'gray',fontSize:fp(1.6), fontWeight:"500",marginTop: hp(1),color:colors.BLACK,padding:wp(2)}}>Services</Text>

          <View style={{flexDirection: 'row', justifyContent: "flex-start",padding:wp(2)}}>
            {services.map((service, index) => (
              <View key={index} style={{alignItems: 'center', 
              justifyContent: 'center',paddingHorizontal:wp(2)}}>
                 <View key={index} style={{alignItems: 'center', padding:wp(3), backgroundColor: '#F1F5FF',
              borderRadius: wp(1), 
              }}>

                <Ionicons name={service.icon} size={fp(3)} color="#007bff" />
</View>
                <Text style={{marginTop: hp(1),fontWeight:"400",}}>{service.label}</Text>
              </View>
            ))}
          </View>

          <Text style={{color: 'gray',fontWeight:"500",fontSize:fp(1.6),padding:wp(2)}}>Fast food</Text>
          <Text style={{marginVertical:hp(-1),fontWeight:"500",color: 'gray',fontSize:fp(1.6),color:colors.BLACK,padding:wp(2)}}>Location</Text>
          ...
          <View style={{flexDirection: 'row', marginTop: hp(1),}}>
            <Icon
              ...
              />
            <Text style={{marginLeft: wp(2), color: 'black',fontWeight:"600"}}>30-35mins</Text> 
            <Text style={{marginLeft: wp(2),marginHorizontal: wp(1), fontWeight:"600",color: 'black'}}>•  2.5km</Text>

            <Text style={{color: 'gray',marginHorizontal: wp(1),fontWeight:"500"}}> •  Lekki Phase</Text>
            <Icon
   ...
   <View style={{borderWidth:fp(0.1),borderColor:"#E4E4E4",marginVertical:hp(2)}}/>
   ...
   <View style={styles.tabBar1}>
            ...
            <TouchableOpacity
                ...
                <View style={[styles.tabBar1, {right: wp(7),marginTop:hp(-0.5)}]}>
                  <FlatList
                    data={filterTabs}
          ...
          {recommended.map(item => (
            <View key={item.id} style={styles.recommendedCard}>
              ...
              <View style={{flex: 1, marginLeft: 12}}>
                ...
                <Text style={{color: 'gray', marginVertical: 4}}>190m</Text>
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
...
const styles = {
  ...
  recommendedImage: {width: 80, height: 80, borderRadius: 8},
  recommendedTitle: {fontSize: 16, fontWeight: 'bold'},
  recommendedPrice: {color: '#007bff', fontWeight: 'bold', marginTop: 8},
  recommendedDesc: {color: 'gray', fontSize: 12},
  addToCart: {
    backgroundColor: '#007bff',
    paddingVertical: 6,
    borderRadius: 4,
